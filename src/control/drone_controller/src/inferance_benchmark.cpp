...
int main()
{
    ...
    std::string model_path = "/home/nv/SWARM-Physical/src/drone_controller/model/acc_8_3_rand_b1_32.engine";  // .engine 路径
    // std::string model_path = "/home/nv/SWARM-Physical/src/drone_controller/model/acc_8_3_rand.engine";  // .engine 路径
