...
class PlannerDefaultMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PlannerDefaultMsg(null);
  ...
  static datatype() {
    ...
    return 'message_typedef/PlannerDefaultMsg';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlannerDefaultMsg(null);
...
module.exports = PlannerDefaultMsg;
