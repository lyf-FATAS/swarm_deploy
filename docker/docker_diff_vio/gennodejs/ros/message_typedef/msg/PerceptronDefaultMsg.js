...
class PerceptronDefaultMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PerceptronDefaultMsg(null);
  ...
  static datatype() {
    ...
    return 'message_typedef/PerceptronDefaultMsg';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerceptronDefaultMsg(null);
...
module.exports = PerceptronDefaultMsg;
