...
class ControllerDefaultMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ControllerDefaultMsg(null);
  ...
  static datatype() {
    ...
    return 'message_typedef/ControllerDefaultMsg';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControllerDefaultMsg(null);
...
module.exports = ControllerDefaultMsg;
